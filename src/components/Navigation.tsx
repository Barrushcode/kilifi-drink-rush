        ...
        <div className="flex items-center justify-between">
          ...
          <NavigationMenu>
            <NavigationMenuList>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/cart" className={cn(navigationMenuTriggerStyle(), "bg-transparent text-barrush-platinum hover:text-rose-600 hover:bg-barrush-steel/20 flex items-center gap-2")}>
