...
const DeliveryZonesSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-l from-blue-950/60 via-pink-900/30 to-barrush-charcoal">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {zones.map((zone, index) => (
            <Card key={index} className={`${zone.special ? 'bg-gradient-to-br from-pink-200/10 via-blue-600/10 to-barrush-gold/10 border-barrush-gold border-2' : 'bg-gradient-to-br from-blue-900/10 via-pink-800/5 to-barrush-burgundy/20 border-barrush-burgundy border'} transition-all duration-300 hover:scale-105 shadow-md`}>
