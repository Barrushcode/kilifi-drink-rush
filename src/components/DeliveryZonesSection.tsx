      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {zones.map((zone, index) => (
            <Card 
              key={index}
              className={`${zone.special ? 'bg-barrush-gold/10 border-barrush-gold border-2' : 'bg-barrush-burgundy/20 border-barrush-burgundy border'} transition-all duration-300 hover:scale-105`}
            >
              <CardContent className="p-8 text-center">
                ...
                {zone.special && (
                  <Badge className="bg-barrush-gold text-barrush-charcoal">
                    Eco-Friendly 🌱
                  </Badge>
                )}
              </CardContent>
        ...
        <div className="text-center mt-12">
          <div className="bg-wood-texture rounded-lg p-6 max-w-2xl mx-auto border-2 border-barrush-gold">
            <p className="text-barrush-cream">
              <strong className="text-barrush-gold">Delivery fees are added to your order total.</strong> 
              <br />We ensure fast, safe delivery to your doorstep across all zones.
            </p>
          </div>
        </div>
      </div>
