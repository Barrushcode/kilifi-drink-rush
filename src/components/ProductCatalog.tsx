                ...
                <Badge
                  ...
                  className={`cursor-pointer px-6 py-2 text-sm font-medium transition-all duration-300 ${
                    selectedCategory === category 
                      ? "bg-barrush-copper text-barrush-midnight hover:bg-barrush-copper/90" 
                      : "border-barrush-steel/40 text-barrush-copper hover:bg-barrush-copper/20 hover:border-barrush-copper"
                  }`}
          ...
          {filteredProducts.map(product => (
            ...
            >
              ...
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-barrush-copper mb-3 font-serif">
                  {product.name}
                </h3>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button 
                    className="bg-barrush-copper hover:bg-barrush-copper/90 text-barrush-midnight font-bold px-6 py-3 transition-all duration-300 hover:scale-105"
                  >
                    Add to Cart
                  </Button>
                </div>
