...
const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-barrush-midnight to-barrush-slate relative">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-bold text-barrush-copper mb-4 font-serif">
            About Barrush
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 mt-16">
            <Card className="bg-glass-effect border-barrush-steel/30 border backdrop-blur-md hover:border-barrush-copper/50 transition-all duration-300">
              <CardContent className="p-10">
                ...
                <h3 className="text-3xl font-bold text-barrush-copper mb-6 font-serif">Urban Curated</h3>
            ...
            <Card className="bg-glass-effect border-barrush-steel/30 border backdrop-blur-md hover:border-barrush-copper/50 transition-all duration-300">
              <CardContent className="p-10">
                <div className="text-6xl mb-6">⚡</div>
                <h3 className="text-3xl font-bold text-barrush-copper mb-6 font-serif">Modern Efficiency</h3>
                <p className="text-barrush-platinum/90 text-lg leading-relaxed">
