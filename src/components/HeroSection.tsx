      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        <div className="animate-fade-in">
          ...
          <Button 
            ...
            size="lg"
            className="bg-barrush-copper hover:bg-barrush-copper/90 text-barrush-midnight font-bold px-16 py-6 text-xl transition-all duration-300 hover:scale-105 shadow-2xl"
          >
            EXPLORE COLLECTION
          </Button>
        </div>
