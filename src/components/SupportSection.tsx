...
const SupportSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-barrush-burgundy/20">
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="bg-barrush-charcoal/80 border-barrush-gold border-2">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-barrush-gold mb-4">
                Get Support on WhatsApp
              </h3>
              <p className="text-barrush-cream mb-6">
              ...
              <Button 
                ...
                size="lg"
                className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-6 text-lg mb-6"
              >
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <Card className="bg-barrush-burgundy/20 border-barrush-burgundy border">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-lg font-bold text-barrush-gold mb-2">Email Support</h4>
                <p className="text-barrush-cream">barrushdelivery@gmail.com</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-barrush-burgundy/20 border-barrush-burgundy border">
              <CardContent className="p-6 text-center">
                <div className="text-3xl mb-3">⏰</div>
                <h4 className="text-lg font-bold text-barrush-gold mb-2">Response Time</h4>
                <p className="text-barrush-cream">Within 30 minutes</p>
              </CardContent>
            </Card>
          </div>
        </div>
