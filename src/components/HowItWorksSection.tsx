...
const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-blue-900/50 via-pink-900/40 to-barrush-burgundy/40">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {steps.map((step, index) => (
            <Card key={index} className="bg-gradient-to-bl from-pink-800/10 via-blue-700/10 to-barrush-charcoal/80 border-barrush-gold border hover:border-barrush-gold/80 transition-all duration-300 hover:scale-105 shadow-md">
