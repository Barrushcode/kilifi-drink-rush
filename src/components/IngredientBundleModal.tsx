...
const IngredientBundleModal: React.FC<IngredientBundleModalProps> = ({
  ...
  const getTotalPrice = () => {
    return ingredients
      .filter(ingredient => ingredient.isMatched && ingredient.quantity > 0)
    ...
    availableIngredients.forEach(ingredient => {
      for (let i = 0; i < ingredient.quantity; i++) {
        addItem({
          ...
          size: 'Standard',
          image: '', // We don't have images for individual ingredients
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3">
              {ingredients.map((ingredient) => (
                <Card key={ingredient.id} className="bg-glass-effect border border-barrush-steel/30">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge 
                            variant={ingredient.isMatched ? "default" : "secondary"}
                            className={`text-xs ${
                      ...
                      {ingredient.isMatched && (
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className="h-8 w-8 p-0 border-barrush-steel/50 text-barrush-platinum hover:border-neon-pink/50"
                          >
            ...
            <div className="border-t border-barrush-steel/30 pt-4">
              ...
              <div className="flex gap-3">
                <Button
                  variant="outline"
                  onClick={onClose}
                  className="flex-1 border-barrush-steel/50 text-barrush-platinum hover:border-neon-pink/50"
                >
                  Cancel
                </Button>
                <Button
